# Friday Night Funkin' Legacy — Modernized for Latest Haxe!

A recompiled and optimized version of [FNF Legacy](https://github.com/FunkinCrew/Funkin/tree/legacy/0.2.x) for modern Haxe. The original code was built with Haxe 4.1.5 and is now compatible with the latest Haxe releases! 
